...
public class DragContainer implements Serializable {
    ...
    public static final DataFormat AddNode = new DataFormat("ui.DragIcon.add");

    public static final DataFormat DragNode = new DataFormat("ui.node.DraggableNode.drag");

    public static final DataFormat AddLink = new DataFormat("ui.NodeLink.add");
